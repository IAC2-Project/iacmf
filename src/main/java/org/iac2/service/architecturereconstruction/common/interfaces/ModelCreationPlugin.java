...
public interface ModelCreationPlugin extends ArchitectureReconstructionPlugin {
    InstanceModel reconstructInstanceModel(ProductionSystem productionSystem)
            throws IaCTechnologyNotSupportedException, MissingProductionSystemPropertyException, MissingConfigurationEntryException, ApiException, FileNotFoundException;
}
